<template>
  <div class="grid lg:grid-cols-2 px-8 gap-4 text-zinc-800 mt-10 max-w-lg">
    <div
    ...
    >
      <div>
        ...
        <p class="opacity-60 text-center">For the individual and small teams</p>
      ...
      <div class="flex flex-col gap-1">
        ...
        <div class="flex justify-center mt-8">
          <button
            class="border px-4 py-2 border-indigo-400 border-4 hover:bg-indigo-100 rounded-xl"
          >
            Get Started
          </button>
        </div>
    ...
    >
      ...
      <p
        class="mono text-sm absolute -top-4 bg-red-400 text-zinc-100 py-0.5 px-2 font-bold tracking-wider rounded"
      >
        POPULAR
      </p>
      <div>
      ...
      <div class="flex flex-col gap-1">
        ...
        <div class="flex justify-center mt-8">
          <button
            class="px-4 py-2 border-indigo-400 border-4 hover:bg-indigo-100 rounded-xl"
          >
            Get Started
          </button>
        </div>
